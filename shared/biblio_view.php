...
<?php if (isset($biblioFlds['020a'])) echo '<td rowspan="8"><img src="http://covers.openlibrary.org/b/isbn/'.$biblioFlds['020a']->getFieldData().'-M.jpg" style="margin-left:10px;padding:3px;border:solid 1px #000;border-radius:5px;" /></td>'; ?>
  </tr>
  <tr>
    <td nowrap="true" class="primary" valign="top">
